										...
										<div class="option clearfix">
								            ...
								            <div id="feed_custom_r" class="select_control_div_div cg_feed_extraction_method cg_feed_extraction_method_regex field f_100">
								               ...
								               <label for="field6">
								                ...
								                <?php 
						 		 		 			...
						 		 		 			<tr>
						 		 		 				...
						 		 		 				<td    style="padding-left:15px;padding-top:8px;" >
						 		 		 					   ...
						 		 		 					   <input title="Single match" name="camp_options[]"   value="OPT_FEED_REGEX_SINGLE_<?php echo $i ?>" type="checkbox">
								                ...
								                <tr><td style="padding-top:20px" colspan="3">Tick the checkbox if you want the a single match only </td></tr>
								                </table>
